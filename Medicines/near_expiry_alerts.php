...
if (isset($_POST['send_email'])) {
    ...
    try {
        foreach ($data as $quarter => $rows) {
            ...
            $body = "<h3>$quarter Expiring Medicines</h3><table border='1' cellpadding='6'>";
            $body .= "<tr><th>Name</th><th>Generic</th><th>Dosage</th><th>Category</th>
...
<html>
<head>
<title>Soon To Expire Medicines</title>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body bg-dark text-white rounded card-blue">
            ...
            <div class="d-grid gap-2">
                <a href="add_medicines.php" class="btn btn-outline-light text-start">➕ Add Products</a>
                <a href="search_medicines.php" class="btn btn-outline-light text-start">🔍 Search Products</a>
                <a href="low_stock_alert.php" class="btn btn-outline-light text-start">⚠ Low Stock</a>
                <a href="expiry_medicines_yearly_quarter.php" class="btn btn-outline-light text-start">📅 Expiry Report</a>
                <a href="near_expiry_alerts.php" class="btn btn-outline-light text-start">📊 Soon Expire</a>
                <a href="expiry_alerts.php" class="btn btn-outline-light text-start">❌ Expired</a>
                <a href="../index.php" class="btn btn-light text-dark fw-semibold text-start">🏠 Dashboard</a>
            </div>
        </div>
    </div>
...
<h3 class="text-center mb-3">Soon To Expire Medicines (Next 12 Months)</h3>
...
<h4 class="text-center">Medicine Details</h4>

<div class="table-responsive">
<table class="table table-bordered table-striped table-hover">
<thead class="table-dark">
<tr>
<th>Name</th><th>Generic</th><th>Dosage</th><th>Category</th>
<th>Rack</th><th>Price</th><th>Stock</th><th>Remaining</th>
